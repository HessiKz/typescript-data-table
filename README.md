...
> Virtualized, sortable, filterable, keyboard-navigable data table library.
...
👉 https://HessiKz.github.io/typescript-data-table/

## Features

- Interactive, client-side visualisation of the Frontend concept
...
git clone https://github.com/HessiKz/typescript-data-table.git
cd typescript-data-table
